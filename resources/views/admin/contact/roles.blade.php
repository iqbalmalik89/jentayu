...
@section('content')
    ...
    <!-- END PAGE BAR -->
    <!-- BEGIN PAGE TITLE-->
    <h3 class="page-title"> Roles Type
<!--         <small>User's Surveys</small> -->

    <a id="addbtn" href="javascript:void(0);" style="float:right;" class="btn btn-primary" href="">Add Role Type</a>
        ...
        <div class="col-md-12">
            ...
            <div class="portlet box green" id="listing_div">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Roles Type </div>
                    <div class="tools">
            ...
            <div class="portlet box green" id="form_div" style="display:none;">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i> Contact Role </div>
                    <div class="tools">
                        <a href="javascript:;" class="collapse" data-original-title="" title=""> </a>
                            ...
                            <div class="form-group last">
                                ...
                                <div class="radio-list">
                                    <label class="radio-inline">
                                        <input type="radio" name="role_status" checked="checked" id="active_status" value="active"> Active </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="role_status" id="inactive_status" value="inactive"> Inactive </label>
                                </div>
                            </div>
