...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('admin_assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('admin_assets/global/plugins/morris/morris.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{ asset('admin_assets/global/css/select2.min.css')}}" rel="stylesheet" id="style_components" type="text/css" />
        ...
        <link href="{{ asset('admin_assets/layouts/layout/css/themes/darkblue.min.css')}}" rel="stylesheet" type="text/css" id="style_color" />
                            ...
                            <div class="portlet light bordered">
                                ...
                                <div class="portlet-body">
                                    <div id="site_statistics_loading">
                                        <img src="{{ asset('admin_assets/global/img/loading.gif')}}" alt="loading" /> </div>
                                            ...
                                            <div class="mt-comments">
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar1.jpg')}}" /> </div>
                                                ...
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar6.jpg')}}" /> </div>
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                                ...
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar8.jpg')}}" /> </div>
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                                ...
                                                <div class="mt-comment">
                                                    <div class="mt-comment-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar4.jpg')}}" /> </div>
                                                    <div class="mt-comment-body">
                                                        <div class="mt-comment-info">
                                    ...
                                    <div class="tab-content">
                                            ...
                                            <div class="mt-actions">
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar10.jpg')}}" /> </div>
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar3.jpg')}}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar2.jpg')}}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar7.jpg')}}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar9.jpg')}}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                        ...
                                        <div class="tab-pane" id="tab_actions_completed">
                                            ...
                                            <div class="mt-actions">
                                                ...
                                                <div class="mt-action">
                                                    <div class="mt-action-img">
                                                        <img src="{{ asset('admin_assets/pages/media/users/avatar5.jpg')}}" /> </div>
                                                    <div class="mt-action-body">
                                                        <div class="mt-action-row">
                                                            <div class="mt-action-info ">
                                                                <div class="mt-action-icon ">
                                ...
                                <div class="portlet-body" id="chats">
                                    <div class="scroller" style="height: 525px;" data-always-visible="1" data-rail-visible1="1">
                                        <ul class="chats">
                                            ...
                                            <li class="in">
                                                <img class="avatar" alt="" src="{{ asset('admin_assets/layouts/layout/img/avatar1.jpg')}}" />
                                                <div class="message">
                                                    <span class="arrow"> </span>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-widget-1">
                                                ...
                                                <div class="mt-img">
                                                    <img src="{{ asset('admin_assets/pages/media/users/avatar80_8.jpg')}}"> </div>
                                                <div class="mt-body">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-widget-1">
                                                ...
                                                <div class="mt-img">
                                                    <img src="{{ asset('admin_assets/pages/media/users/avatar80_7.jpg')}}"> </div>
                                                <div class="mt-body">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="mt-widget-1">
                                                ...
                                                <div class="mt-img">
                                                    <img src="{{ asset('admin_assets/pages/media/users/avatar80_6.jpg')}}"> </div>
                                                <div class="mt-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="mt-widget-2">
                                                <div class="mt-head" style="background-image: url({{ asset('admin_assets/pages/img/background/32.jpg')}});">
                                                    <div class="mt-head-label">
                                                        <button type="button" class="btn btn-success">Manhattan</button>
                                                    </div>
                                                    <div class="mt-head-user">
                                                        <div class="mt-head-user-img">
                                                            <img src="{{ asset('admin_assets/pages/img/avatars/team7.jpg')}}"> </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mt-widget-2">
                                                <div class="mt-head" style="background-image: url({{ asset('admin_assets/pages/img/background/43.jpg')}});">
                                                    <div class="mt-head-label">
                                                        <button type="button" class="btn btn-danger">London</button>
                                                    </div>
                                                    <div class="mt-head-user">
                                                        <div class="mt-head-user-img">
                                                            <img src="{{ asset('admin_assets/pages/img/avatars/team3.jpg')}}"> </div>
                                                        <div class="mt-head-user-info">
                                ...
                                <div class="portlet-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="mt-widget-4">
                                                <div class="mt-img-container">
                                                    <img src="{{ asset('admin_assets/pages/img/background/34.jpg')}}" /> </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mt-widget-4">
                                                <div class="mt-img-container">
                                                    <img src="{{ asset('admin_assets/pages/img/background/46.jpg')}}" /> </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mt-widget-4">
                                                <div class="mt-img-container">
                                                    <img src="{{ asset('admin_assets/pages/img/background/37.jpg')}}" /> </div>
...
<![endif]-->
        ...
        <script src="{{ asset('admin_assets/global/plugins/bootstrap-daterangepicker/daterangepicker.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{ asset('admin_assets/global/plugins/counterup/jquery.waypoints.min.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/counterup/jquery.counterup.min.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/amcharts.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/serial.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/pie.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/radar.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/themes/light.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/themes/patterns.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amcharts/themes/chalk.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/ammap/ammap.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/ammap/maps/js/worldLow.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/plugins/amcharts/amstockcharts/amstock.js')}}" type="text/javascript"></script>
        ...
        <script src="{{ asset('admin_assets/global/scripts/select2.full.min.js')}}" type="text/javascript"></script>
