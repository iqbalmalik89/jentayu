...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('admin_assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css')}}" rel="stylesheet" type="text/css" />
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white">
        ...
        <div class="page-container">
            ...
            <div id="del_popup" class="modal fade" style="display: none;">
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <button type="button" id="del_btn" class="btn btn-primary">Yes</button>
...
<![endif]-->
        ...
        <script src="{{ asset('admin_assets/js_modules/config.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('admin_assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/global/scripts/app.min.js')}}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/pages/scripts/components-bootstrap-select.min.js')}}" type="text/javascript"></script>
        ...
        <script src="{{ asset('admin_assets/js_modules/utility.js') }}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/js_modules/validator.js') }}" type="text/javascript"></script>
        <script src="{{ asset('admin_assets/js_modules/')}}/@yield('jsmodule')" type="text/javascript"></script>
