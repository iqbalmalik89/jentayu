        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset">
                    <div class="login-bg" style='background-image:url(admin_assets/pages/img/login/bg1.jpg)'>
                        <img class="login-logo" src="{{ asset('admin_assets/pages/img/login/logo.png') }}" /> </div>
                </div>
...
<!--                             <div class="col-xs-5 bs-reset">
 ...
 -->                            <div class="col-xs-7 bs-reset">
                                <div class="login-copyright text-right">
                                    <p>Copyright &copy; Prime Solutions</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<![endif]-->
        ...
        <script src="{{ asset('admin_assets/pages/scripts/login-5.js') }}" type="text/javascript"></script>
        ...
        <script src="{{ asset('admin_assets/js_modules/auth.js') }}" type="text/javascript"></script>
